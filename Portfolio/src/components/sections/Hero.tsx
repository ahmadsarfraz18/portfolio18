        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-8 items-center">
          ...
          >
            ...
            <motion.div variants={itemVariants} className="space-y-4">
              ...
              <h2 className="text-2xl sm:text-3xl font-medium tracking-tight text-muted-foreground">
                {portfolioData.hero.title}
              </h2>
            </motion.div>
            
            <motion.p variants={itemVariants} className="max-w-[42rem] text-lg md:text-xl leading-relaxed text-muted-foreground/80">
            ...
            <motion.div variants={itemVariants} className="flex flex-wrap items-center gap-4 pt-4">
              <Link 
                href="#flagship" 
                className="group inline-flex h-12 items-center justify-center rounded-full bg-foreground px-8 text-sm font-medium text-background transition-all duration-500 ease-out hover:scale-[1.02] hover:-translate-y-1 hover:bg-foreground/90 hover:shadow-lg active:scale-95 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary/50"
              >
                Explore My Work
              ...
              <Link 
                href="#contact" 
                className="inline-flex h-12 items-center justify-center rounded-full border border-transparent bg-transparent px-4 text-sm font-medium text-muted-foreground transition-all duration-300 hover:text-foreground active:scale-95 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary/50"
              >
                Let's Connect
              </Link>
